    ...
    return (
        <>
            <div className="privacy">
                ...
                <p>
                    Our Terms and Conditions (&ldquo;<strong>Terms</strong>
                    &rdquo;) govern all use of our Service and together with the
                    Privacy Policy constitutes your agreement with us (&ldquo;
                ...
                <p>
                    ...
                    from those and other information either in our possession or
                ...
                <p>
                    ...
                    legal person who (either alone or jointly or in common with
                ...
                <p>
                    <strong>DATA SUBJECT&nbsp;</strong>is any living individual
                ...
                <p>
                    ...
                    to contact or identify you (&ldquo;
                    <strong>Personal Data</strong>
                ...
                <p>
                    ...
                    or through a mobile device (&ldquo;
                    <strong>Usage Data</strong>
                    &rdquo;).
                </p>
                <p>
                ...
                <p>
                    ...
                    give us permission to do so (&ldquo;
                    <strong>Location Data</strong>
                ...
                <ul>
                    <li>
                        for the purpose of including your company&rsquo;s logo
                        on our website;
                    </li>
                </ul>
                ...
                <p>
                    ...
                    comply with this policy. &ndash; See more at:
                ...
                <ul>
                    <li>
                        <strong>To delete your personal information</strong>. If
                        you make this request, we will delete the personal
                        information we hold about you as of the date of your
                        request from our records and direct any service
                        providers to do the same. In some cases, deletion may be
                        accomplished through de-identification of the
                        information. If you choose to delete your personal
                        information, you may not be able to use certain
                        functions that require your personal information to
                        operate.
                    </li>
                </ul>
                <p></p>
                <ul>
                    <li>
                        ...
                        to any third parties for any purpose. You are the only
                        owner of your Personal Data and can request disclosure
                ...
                <p>
                    ...
                    <strong>Service Providers</strong>&rdquo;), provide Service
                ...
                <p>
                    ...
                    what purpose and how the protection of the data is ensured,
                    please visit Circle CI Privacy Policy page:
                ...
                <p>
                    ...
                    https://tools.google.com/dlpage/gaoptout &ndash; for your
                    web browser. Google Analytics Opt-out Browser Add-on
                ...
                <p>
                    ...
                    age of 18 (&ldquo;<strong>Child</strong>&rdquo; or &ldquo;
